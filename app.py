...
app = Flask(__name__)
DB_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'ahpc_civil5.db')
...
def exportar_pdf():
    ...
    elements = [
        ...
        Paragraph("Juzgado Civil Capital 5° Nominación · Índice Onomástico de Expedientes (1912–1929)", sub),
        Spacer(1, .2*inch),
    ]
    ...
    t.setStyle(TableStyle([
        ('BACKGROUND',    (0,0), (-1,0), colors.HexColor('#0a2e1a')),
        ('TEXTCOLOR',     (0,0), (-1,0), colors.HexColor('#a8e8c8')),
    ...
    resp.headers['Content-Disposition'] = 'inline; filename=ahpc_civil5.pdf'
    return resp
